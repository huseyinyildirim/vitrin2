<%@ Page Language="C#" AutoEventWireup="true" CodeFile="header-slogan-resimleri.aspx.cs"
...
.x-editable
{
	...
	<ext:Viewport ID="Viewport1" runat="server" Layout="FitLayout" StyleSpec="background-color:#F0F0F0">
		<Items>
			<ext:Window ID="Window1" runat="server" Maximized="true" Title="Header (Slogan) Resimleri [K]"
				Layout="FitLayout" Icon="Photo" Closable="false" Minimizable="false" MinHeight="480"
				MinWidth="640">
				<Items>
