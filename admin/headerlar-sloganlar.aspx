<%@ Page Language="C#" AutoEventWireup="true" CodeFile="headerlar-sloganlar.aspx.cs"
...
<body>
	<script type="text/javascript">
		...
		var HeaderYol = function (data) {
			return String.format("<a href=\"" + data.replace(data, "../images/header/" + data) + "\" target=\"_blank\">" + data + "</a>");
		};
				...
				case "IslemKaydi":
					...
					var win = new Ext.Window({
						...
						autoLoad: {
							...
							showMask: true,
							mode: "iframe",
							url: "isleme-ait-kayitlar.aspx?tablo_adi=tbl_headerlar&kayit_id=" + record.data.id,
							scripts: true
						},
						buttonAlign: 'right',
						buttons: [
	...
	<ext:Viewport ID="Viewport1" runat="server" Layout="FitLayout" StyleSpec="background-color:#F0F0F0">
		<Items>
			<ext:Window ID="Window1" runat="server" Maximized="true" Title="Headerlar (Sloganlar)"
				Layout="FitLayout" Icon="PictureKey" Closable="false" Minimizable="false" MinHeight="480"
				MinWidth="640">
				<Items>
					<ext:GridPanel ID="GridPanel1" runat="server" ColumnLines="true" SortType="AsUCString"
						...
						<ColumnModel runat="server">
							<Columns>
								...
								<ext:Column DataIndex="resim" Header="Resim Yol">
									<Renderer Fn="HeaderYol" />
								</ext:Column>
