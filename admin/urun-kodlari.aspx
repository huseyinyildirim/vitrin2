<%@ Page Language="C#" AutoEventWireup="true" CodeFile="urun-kodlari.aspx.cs" Inherits="yonetim_Kullanici"
...
<body>
	<script type="text/javascript">
		...
		var DuzenleKontrol = function () {
			if (!Duzenle_TextFieldKod.validate()) {
				...
				case "IslemKaydi":
					...
					var win = new Ext.Window({
						...
						autoLoad: {
							...
							showMask: true,
							mode: "iframe",
							url: "isleme-ait-kayitlar.aspx?tablo_adi=tbl_kodlar&kayit_id=" + record.data.id,
							scripts: true
						},
						buttonAlign: 'right',
						buttons: [
	...
	<ext:Viewport ID="Viewport1" runat="server" Layout="FitLayout" StyleSpec="background-color:#F0F0F0">
		<Items>
			<ext:Window ID="Window1" runat="server" Maximized="true" Title="Ürün Kodları" Layout="FitLayout"
				Icon="PackageLink" Closable="false" Minimizable="false" MinHeight="480" MinWidth="640">
				<Items>
					<ext:GridPanel ID="GridPanel1" runat="server" ColumnLines="true" SortType="AsUCString"
						AutoExpandColumn="kod" OnBeforeClientInit="GridPanelYuklenmedenOnce" AnchorHorizontal="100%"
						...
						<ColumnModel runat="server">
							<Columns>
								...
								<ext:Column DataIndex="kod" Header="Kod" />
						...
						<Plugins>
							<ext:GridFilters runat="server" ID="GridFilters1" Local="true">
								<Filters>
									...
									<ext:StringFilter DataIndex="kod" />
			...
			<ext:Window ID="WindowEkle" runat="server" Modal="false" Resizable="True" Height="500"
				...
				Hidden="true">
				<Items>
					<ext:TextField MsgTarget="Side" AllowBlank="false" ID="Ekle_TextFieldKod" MaxLength="7" MaxLengthText="Maksimum karakter sınırını aştınız."
						runat="server" FieldLabel="Kod" BlankText="Lütfen bir kod yazın." AnchorHorizontal="96%" IndicatorIcon="BulletStar" IndicatorTip="Zorunlu alan"
			...
			<ext:Window ID="WindowDuzenle" runat="server" Modal="true" Resizable="True" Height="500"
				...
				<Items>
					...
					<ext:TextField MsgTarget="Side" AllowBlank="false" ID="Duzenle_TextFieldKod" MaxLength="7" MaxLengthText="Maksimum karakter sınırını aştınız."
						runat="server" FieldLabel="Kod" BlankText="Lütfen bir kod yazın." AnchorHorizontal="96%" IndicatorIcon="BulletStar" IndicatorTip="Zorunlu alan"
						EnableKeyEvents="true">
						<Listeners>
							<KeyUp Handler="this.setValue(this.getValue().toUpperCase());" />
