<%@ Page Language="C#" AutoEventWireup="true" CodeFile="giris-hatalari.aspx.cs" Inherits="yonetim_Kullanici"
				...
				case "TumBilgiler":
					...
					var win2 = new Ext.Window({
						...
						autoLoad: {
							...
							showMask: true,
							mode: "iframe",
							url: "ziyaret-bilgi.aspx?tablo_adi=tbl_giris_cikislar_hatalar&kayit_id=" + record.data.id,
							scripts: true
						},
						buttonAlign: 'right',
						buttons: [
