<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bottom-header-resimleri.aspx.cs"
	Inherits="yonetim_dosyalar2" EnableViewState="False" ViewStateMode="Disabled"
...
.x-editable
{
	...
	<ext:Viewport ID="Viewport1" runat="server" Layout="FitLayout" StyleSpec="background-color:#F0F0F0">
		<Items>
			<ext:Window ID="Window1" runat="server" Maximized="true" Title="Bottom Header Resimleri [K]"
				Layout="FitLayout" Icon="PicturesThumbs" Closable="false" Minimizable="false" MinHeight="480"
				MinWidth="640">
				<Items>
