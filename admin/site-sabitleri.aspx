<%@ Page Language="C#" AutoEventWireup="true" CodeFile="site-sabitleri.aspx.cs" Inherits="yonetim_Kullanici"
...
<body>
	<script type="text/javascript">
		var XMLTemplate = '<span style="color:{0};font-weight:{1}">{2}</span>';

		var XMLRenk = function (v) {
			return String.format(XMLTemplate, (v == "EVET") ? "red" : "black", (v == "EVET") ? "bold" : "normal", v);
		};
	...
	<ext:Viewport ID="Viewport1" runat="server" Layout="FitLayout" StyleSpec="background-color:#F0F0F0">
		<Items>
			<ext:Window ID="Window1" runat="server" Maximized="true" Title="Site Sabitleri" Layout="FitLayout"
				Icon="CalendarViewWeek" Closable="false" Minimizable="false" MinHeight="480" MinWidth="640">
				<Items>
					<ext:GridPanel ID="GridPanel1" runat="server" ColumnLines="true" SortType="AsUCString" AutoExpandColumn="aciklama"
						...
						<ColumnModel runat="server">
							<Columns>
								...
								<ext:Column DataIndex="aciklama" Header="Aciklama" />
								<ext:Column DataIndex="sayfa" Header="Sayfa" />
								<ext:Column DataIndex="xml" Header="XML">
								<Renderer Fn="XMLRenk" />
								</ext:Column>
							</Columns>
						</ColumnModel>
						<Plugins>
							<ext:GridFilters runat="server" ID="GridFilters1" Local="true">
								<Filters>
									...
									<ext:StringFilter DataIndex="sayfa" />
									<ext:ListFilter DataIndex="xml" Options="EVET,HAYIR" />
								</Filters>
							</ext:GridFilters>
						</Plugins>
						<SelectionModel>
