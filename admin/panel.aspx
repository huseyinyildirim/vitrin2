<%@ Page Language="C#" AutoEventWireup="true" CodeFile="panel.aspx.cs" Inherits="yonetim_panel"
			...
			<ext:Panel ID="Panel2" runat="server" Title="» İŞLEMLER" Icon="Plugin" Region="West"
				...
				<Items>
					...
					<ext:MenuPanel ID="MenuPanel4" runat="server" Title="Bottom/Header İşlemleri" Icon="Pictures"
						...
						<Menu ID="Menu5" runat="server">
							...
							<ext:MenuItem ID="MenuItem42" runat="server" Text="Bottom (Copyright İmi)" Icon="TextAlignJustify">
								...
								<ext:MenuItem ID="MenuItem7" runat="server" Text="Bottom/Header Resim İşlemleri" Icon="PictureSave">
									<Listeners>
					...
					<ext:MenuPanel ID="MenuPanel7" runat="server" Title="Online Kişiler" Icon="Connect"
						...
						<ext:MenuPanel ID="MenuPanel16" runat="server" Title="Firma İşlemleri" Icon="Building"
						Border="false" Collapsed="true">
					...
					<ext:MenuPanel ID="MenuPanel17" runat="server" Title="İstatistikler" Icon="ChartBar"
						Border="false" Collapsed="true">
						<Menu ID="Menu14" runat="server">
							<Items>
								...
								<ext:MenuItem ID="MenuItem41" runat="server" Text="* Dosya/Klasör İstatistikleri" Icon="ChartOrganisation">
									<Listeners>
